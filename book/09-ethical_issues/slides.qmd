...
- It might even be contrary to the terms of service of the website.
...
- Imagine a human tried to enter a website 5 times per second continuously for 48 hours
...
- If you're scraping a website and making only a *single* request, it shouldn't matter.

- So how to avoid spamming requests?
...
- Sometimes the `robots.txt` file will tell you

- Multiplying the total number of websites you'll scrape by the number of seconds you'll sleep will give you a rough estimate of how much time your program will take.
...
- These terms of service are lengthy and contain a lot of information on what the website can do with your data
...
- Whenever you intend to scrape a website, make sure to read the terms of service.
...
- Standard file called `robots.txt` on nearly all websites on the internet which tells you what parts of the website can be scraped.
