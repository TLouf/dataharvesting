...
Let's see what one school website looks like:
...
We need some regex skills to extract this. Let's brainstorm:
...
Great, that's it, this is the data we've been looking for in the entire chapter. Let's summarize the work so far:
...
school_grabber <- function(school_url) {
  # We add a time sleep of 1 second to avoid
...
- Correlating private/public school quotas with income can help understand inequality patterns
...
- Instead: detect `Tipo Centro`, generic for "Type of center"
...
- Chapters 10 and 11 -- read + exercises
