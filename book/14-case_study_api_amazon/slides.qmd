...
- Link user behavior through different endpoints. Take user `319` (see [14.2](./index.html#understand-amazon-books)) and see which other products the user has bought on Amazon.
